...
= > with GET method the sended data wil appear in the Request URL as params added to it  
= > with Post method you will see the data in the FormDatam Data
...
// Convert this JS object into a JSON object. What happens to the nested objects ?Convert and pretty print this JS object into a JSON object. Hint : 
// Check out the JSON lesson on the platform. Use your web inspector to add a breakpoint. 
